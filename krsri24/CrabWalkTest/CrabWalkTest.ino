...
void loop() {
  ...
  LeftFront(6,6,5.5,speed,servo_delay);
  LeftMid(6,6,5.5,speed,servo_delay);
  LeftBack(6,6,5.5,speed,servo_delay);

  RightFront(10,10,5.5,speed,servo_delay);
  RightMid(10,10,5.5,speed,servo_delay);
  RightBack(10,10,5.5,speed,servo_delay);

  delay(3000);

  //WALK TEST START 1 (JARAK JALAN DEKAT)
