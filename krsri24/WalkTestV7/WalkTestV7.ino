...
void turn_left_obstacle(){
  ...
  LeftFront(7.25,8.75,2.5,speed,servo_delay);
  RightMid(8.75,7.25,2.5,speed,servo_delay);
  LeftBack(7.25,8.75,2.5,speed,servo_delay);

  delay(10);

  //2
  LeftFront(8.75,7.25,2.5,speed,servo_delay);
  RightMid(7.25,8.75,2.5,speed,servo_delay);
  LeftBack(8.75,7.25,2.5,speed,servo_delay);
  ...
  RightFront(8.75,7.25,2.5,speed,servo_delay);
  LeftMid(7.25,8.75,2.5,speed,servo_delay);
  RightBack(8.75,7.25,2.5,speed,servo_delay);
  ...
  RightFront(7.25,8.75,2.5,speed,servo_delay);
  LeftMid(8.75,7.25,2.5,speed,servo_delay);
  RightBack(7.25,8.75,2.5,speed,servo_delay);
}
...
void crabwalk_left_ladder(){
  ...
  LeftFront(8,5,0,speed,servo_delay);
  RightMid(9.4,9.4,2,speed,servo_delay);
  LeftBack(5,8,0,speed,servo_delay);

  LeftFront(12,5,0,speed,servo_delay);
  RightMid(6.6,6.6,3.5,speed,servo_delay);
  LeftBack(5,12,0,speed,servo_delay);

  delay(10);

  RightFront(10,5,6,speed/3,servo_delay);
  LeftMid(8,8,4,speed/3,servo_delay);
  RightBack(5,10,6,speed/3,servo_delay);

  //2
  RightFront(12,5,6,speed/3,servo_delay);
  LeftMid(6.6,6.6,4,speed/3,servo_delay);
  RightBack(5,12,6,speed/3,servo_delay);
  ...
  RightFront(12,5,2,speed,servo_delay);
  LeftMid(6.6,6.6,0,speed,servo_delay);
  RightBack(5,12,2,speed,servo_delay);

  RightFront(8,5,2,speed,servo_delay);
  LeftMid(9.4,9.4,0,speed,servo_delay);
  RightBack(5,8,2,speed,servo_delay);

  LeftFront(10,5,4,speed/3,servo_delay);
  RightMid(8,8,6,speed/3,servo_delay);
  LeftBack(5,10,4,speed/3,servo_delay);

  //4
  LeftFront(8,5,4,speed/3,servo_delay);
  RightMid(9.4,9.4,6,speed/3,servo_delay);
  LeftBack(5,8,4,speed/3,servo_delay);
...
void crabwalk_right_ladder(){
  ...
  RightMid(6.6,6.6,0,speed,servo_delay);
  LeftBack(5,12,2,speed,servo_delay);

  LeftFront(8,5,2,speed,servo_delay);
  RightMid(9.4,9.4,0,speed,servo_delay);
...
void walk_to_victim_obstacle(){
  //1
  RightFront(7,9,5,speed,servo_delay);
  LeftMid(7,9,5,speed,servo_delay);
  RightBack(7,9,5,speed,servo_delay);

  delay(50);

  LeftFront(9,7,1.5,speed,servo_delay);
  RightMid(9,7,1.5,speed,servo_delay);
  LeftBack(9,7,1.5,speed,servo_delay);

  delay(50);

  //2
  LeftFront(7,9,1.5,speed,servo_delay);
  RightMid(7,9,1.5,speed,servo_delay);
  LeftBack(7,9,1.5,speed,servo_delay);

  RightFront(9,7,5,speed/2.5,servo_delay);
  LeftMid(9,7,5,speed/2.5,servo_delay);
  RightBack(9,7,5,speed/2.5,servo_delay);
  
  delay(150);

  //4
  LeftFront(7,9,5,speed,servo_delay);
  RightMid(7,9,5,speed,servo_delay);
  LeftBack(7,9,5,speed,servo_delay);

  delay(50);

  RightFront(9,7,1.5,speed,servo_delay);
  LeftMid(9,7,1.5,speed,servo_delay);
  RightBack(9,7,1.5,speed,servo_delay);
  
  delay(50);

  //4
  LeftFront(9,7,5,speed/2.5,servo_delay);
  RightMid(9,7,5,speed/2.5,servo_delay);
  LeftBack(9,7,5,speed/2.5,servo_delay);

  RightFront(7,9,1.5,speed,servo_delay);
  LeftMid(7,9,1.5,speed,servo_delay);
  RightBack(7,9,1.5,speed,servo_delay);
